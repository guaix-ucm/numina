...
class CosmeticsTestCase(unittest.TestCase):
    ...
    def test_exceptions(self):
        ...
        self.assertRaises(ValueError, cosmetics, self.flat1,
                          self.flat2, self.mask, lowercut=0.0)
        self.assertRaises(ValueError, cosmetics, self.flat1,
                          self.flat2, self.mask, uppercut=0.0)
        self.assertRaises(ValueError, cosmetics, self.flat1,
                          self.flat2, self.mask, siglev=0.0)

        self.assertRaises(ValueError, cosmetics, self.flat1,
                          self.flat2, self.mask, lowercut=-1.0)
        self.assertRaises(ValueError, cosmetics, self.flat1,
                          self.flat2, self.mask, uppercut=-10.0)
        self.assertRaises(ValueError, cosmetics, self.flat1,
                          self.flat2, self.mask, siglev=-20.0)
...
class CcdmaskTestCase(unittest.TestCase):
    ...
    def test_exceptions(self):
        ...
        self.assertRaises(ValueError, ccdmask, self.flat1,
                          self.flat2, self.mask, lowercut=0.0)
        self.assertRaises(ValueError, ccdmask, self.flat1,
                          self.flat2, self.mask, uppercut=0.0)
        self.assertRaises(ValueError, ccdmask, self.flat1,
