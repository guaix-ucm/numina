...
def test_trace_simple(benchmark, gauss):
    ...
    if gauss:
        result = np.array(
            [[44., 48.02061133, 3.50749737], [45., 48.02061133, 4.20064455],
             [46., 48.02061133, 4.60610966], [47., 48.02061133, 4.60610966],
             [48., 48., 100.], [49., 48.02061133, 4.60610966],
             [50., 48.02061133, 4.60610966], [51., 48.02061133, 4.60610966],
             [52., 48.02061133, 4.60610966], [53., 48.02061133, 4.60610966],
             [54., 48.02061133, 4.20064455], [55., 48.02061133, 3.50749737]])
    else:
