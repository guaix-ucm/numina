 ...
 *             mcount += 1
 */
  for (__pyx_t_3 = __pyx_v_nmed; __pyx_t_3 > 0; __pyx_t_3-=1) {
    __pyx_v_i = __pyx_t_3;
  ...
  __Pyx_RefNannySetupContext("kernel_peak_function (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        case  1:
        if (kw_args > 0) {
          PyObject* value = PyDict_GetItem(__pyx_kwds, __pyx_n_s_fpeak);
...
static int __pyx_pymod_exec__kernels(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  int __pyx_t_1;
