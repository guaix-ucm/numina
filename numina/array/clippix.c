 ...
 */
            ...
            __pyx_t_4 = PyFloat_FromDouble((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_image2d.data + __pyx_t_20 * __pyx_v_image2d.strides[0]) ) + __pyx_t_19 * __pyx_v_image2d.strides[1]) )))); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 227, __pyx_L1_error)
            __Pyx_GOTREF(__pyx_t_4);
