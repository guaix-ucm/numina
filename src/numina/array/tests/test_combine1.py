...
import numina.array._combine2 as _c2  # noqa
...
class CombineTestCase(unittest.TestCase):
    ...
    def test_CombineError(self):
        ...
        self.assertRaises(c.CombineError, c.generic_combine,
                          _c2.mean_method, self.validImages,
                          out=self.validOut,
    ...
    def testCombineSum(self):
        ...
        # Checking
        assert numpy.allclose(out[0], rres)
        assert numpy.allclose(out[1], rvar)
        assert numpy.allclose(out[2], rnum)
...
def test_combine_maxargs():
    ...
    out0, out1, out2 = c.generic_combine(_c2.median_method(), inputs)
