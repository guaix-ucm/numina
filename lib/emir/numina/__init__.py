...
class RecipeBase:
    ...
    def __init__(self, optusage = None):
        ...
        self.cmdoptions.add_option('--docs', action="store_true", dest="docs", default=False, help="prints documentation")
...
def class_loader(path, default_module, logger = Null()):
    ...
    if inspect.isclass(RecipeClass) and issubclass(RecipeClass, RecipeBase) and not RecipeClass is RecipeBase:
        return RecipeClass
    # In other case
    return None
